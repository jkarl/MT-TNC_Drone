...
#Argument is the project.scratch directory.
arcpy.env.workspace = sys.argv[1]


# Local variables:
sage_pred_tif = "scratch/sagepred.tif"
...
Con_RegionG_1 = "scratch/sage_class.tif"
aoi = "products/aoi.tif"

# Process: Con
arcpy.gp.Con_sa(sage_pred_tif, Input_true_raster_or_constant_value, Con_tif1, Input_false_raster_or_constant_value, "VALUE > 0.5")
...
# Process: Con (2)
arcpy.gp.Con_sa(RegionG_Boun2, Input_true_raster_or_constant_value__2_, Con_RegionG_1, Boundar_Majo2, "LINK = 1 AND COUNT < 100")
...
arcpy.Delete_management(sage_pred_tif)
